...
import { getCustomerStatement, getAssetLedgers, recordPayment, getLiabilityLedgers } from '../../../services/accountingService'
                ...
                selectedCustomer && (
                    <>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
                            ...
                            <SummaryCard title="Balance Due" value={balance} color={balance > 0 ? '#fef3c7' : '#ecfdf5'} textColor={balance > 0 ? '#f59e0b' : '#10b981'} highlight />
                        </div>
